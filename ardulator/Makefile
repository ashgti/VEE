...
CXXFLAGS=$(CFLAGS)
LD_FLAGS=-lm
OBJ_FILES := src/pin.o src/hardware_serial.o src/pin_commands.o src/timing.o src/main.o src/arduino.o src/rand_num.o src/signal.o src/interrupt_commands.o src/bit_value.o $(EXT_OBJ_FILES)
SRC_FILES := src/pin.cc src/hardware_serial.cc src/pin_commands.cc src/timing.cc src/main.cc src/arduino.cc src/rand_num.cc src/signal.cc src/interrupt_commands.cc src/bit_value.cc $(EXT_FILES)
